...
const meta: Meta<typeof ReceivedNotificationModal> = {
  title: 'Features/Notification/ReceivedNotificationModal',
  component: ReceivedNotificationModal,
  tags: ['autodocs'],
  args: { onClose: () => {} },
  decorators: [
    (Story) => (
...
type Story = StoryObj<typeof ReceivedNotificationModal>;
